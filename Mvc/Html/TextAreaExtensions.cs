...
namespace System.Web.Mvc.Html
{
	public static class TextAreaExtensions
	{
		...
		public static string TextArea(this HtmlHelper htmlHelper, string name, IDictionary<string, object> htmlAttributes)
		{
			...
			var implicitAttributes = new Dictionary<string, object>();
			...
			return TextAreaHelper(htmlHelper, name, true /* useViewData */, null /* value */, implicitAttributes, null
			                      /* explicitParameters */, htmlAttributes);
		}
		                              ...
		                              IDictionary<string, object> htmlAttributes)
		{
			...
			implicitAttributes.Add("rows", TextAreaRows.ToString(CultureInfo.InvariantCulture));
			implicitAttributes.Add("cols", TextAreaColumns.ToString(CultureInfo.InvariantCulture));
			return TextAreaHelper(htmlHelper, name, (value == null) /* useViewData */, value, implicitAttributes, null
			                      /* explicitParameters */, htmlAttributes);
		}

		public static string TextArea(this HtmlHelper htmlHelper, string name, string value, int rows, int columns,
		                              ...
		                              IDictionary<string, object> htmlAttributes)
		{
			...
			return TextAreaHelper(htmlHelper, name, (value == null) /* useViewData */, value, null /* implictAttributes */,
			                      explicitParameters, htmlAttributes);
		}

		static string TextAreaHelper(this HtmlHelper htmlHelper, string name, bool useViewData, string value,
		                             IDictionary<string, object> implicitAttributes,
		                             IDictionary<string, object> explicitParameters,
		                             IDictionary<string, object> htmlAttributes)
		{
			...
			tagBuilder.SetInnerText(Environment.NewLine +
			                        (attemptedValue ?? ((useViewData) ? htmlHelper.EvalString(name) : value)));
