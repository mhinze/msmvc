...
namespace System.Web.Mvc.Html
{
	public static class InputExtensions
	{
		...
		{
			return htmlHelper.InputHelper(InputType.CheckBox, name, "true", true /* useViewData */, false /* isChecked */, true
			                              /* setId */, false /* isExplicitValue */, htmlAttributes);
		}
		                              ...
		                              IDictionary<string, object> htmlAttributes)
		{
			...
			return htmlHelper.InputHelper(InputType.CheckBox, name, "true", false /* useViewData */, isChecked, true /* setId */,
			                              false /* isExplicitValue */, attributes);
		}
		...
		public static string Hidden(this HtmlHelper htmlHelper, string name, object value,
		                            IDictionary<string, object> htmlAttributes)
		{
			return InputHelper(htmlHelper, InputType.Hidden, name, value, (value == null) /* useViewData */, false
			                   /* isChecked */, true /* setId */, true /* isExplicitValue */, htmlAttributes);
		}
		...
		public static string Password(this HtmlHelper htmlHelper, string name, object value,
		                              IDictionary<string, object> htmlAttributes)
		{
			return InputHelper(htmlHelper, InputType.Password, name, value, false /* useViewData */, false /* isChecked */, true
		                                 ...
		                                 IDictionary<string, object> htmlAttributes)
		{
			...
			var isChecked = (!String.IsNullOrEmpty(name)) &&
			                (String.Equals(htmlHelper.EvalString(name), valueString, StringComparison.OrdinalIgnoreCase));
			...
			{
				return htmlHelper.InputHelper(InputType.Radio, name, value, false, false, true, true /* isExplicitValue */,
				                              attributes);
			}
		                                 ...
		                                 IDictionary<string, object> htmlAttributes)
		{
			...
			var attributes = htmlAttributes == null ? new RouteValueDictionary() : new RouteValueDictionary(htmlAttributes);
			attributes.Remove("checked");
			return htmlHelper.InputHelper(InputType.Radio, name, value, false, isChecked, true, true /* isExplicitValue */,
			                              attributes);
		}
		...
		static string InputHelper(this HtmlHelper htmlHelper, InputType inputType, string name, object value, bool useViewData,
		                          bool isChecked, bool setId, bool isExplicitValue, IDictionary<string, object> htmlAttributes)
		{
			...
			switch (inputType)
			{
				case InputType.CheckBox:
					var modelStateWasChecked = htmlHelper.GetModelStateValue(name, typeof(bool)) as bool?;
				...
				case InputType.Radio:
					if (!usedModelState)
					{
						var modelStateValue = htmlHelper.GetModelStateValue(name, typeof(string)) as string;
				...
				case InputType.Password:
					...
					break;
				default:
					var attemptedValue = (string)htmlHelper.GetModelStateValue(name, typeof(string));
					tagBuilder.MergeAttribute("value", attemptedValue ?? ((useViewData) ? htmlHelper.EvalString(name) : valueParameter),
					                          isExplicitValue);
					break;
			}
